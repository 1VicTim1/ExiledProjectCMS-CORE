...
- PROMETHEUS_WEB_USER, PROMETHEУС_WEB_PASSWORD_BCRYPT — включает базовую авторизацию UI Prometheus (опционально).
...
(см. папку `login-frontend/`).

- Где найти исходники: `login-frontend/`
