...
show_completion_info() {
    ...
    echo -e "${GREEN}Start services:${NC}   docker-compose -f $COMPOSE_FILE up -d"
    ...
    echo -e "${GREEN}Update system:${NC}    git pull && docker-compose -f $COMPOSE_FILE build --pull"
    ...
    echo -e "${YELLOW}• Please backup your .env file - it contains sensitive information${NC}"
